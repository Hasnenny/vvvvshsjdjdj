...
async def toba1(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/7")
...
async def toba2(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/8")
...
async def toba3(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/9")
...
async def toba4(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/10")
...
async def toba5(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/11")
...
async def toba6(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/12")
...
async def toba7(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/13")
...
async def toba8(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/14")
...
async def toba9(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/15")
...
async def toba10(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/16")
...
async def toba11(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/17")
...
async def toba12(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/18")
...
async def toba13(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/19")
...
async def toba14(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/20")
...
async def toba15(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/21")
...
async def toba16(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/22")
...
async def toba17(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/23")
...
async def toba18(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/24")
...
async def toba19(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/25")
...
async def toba20(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/26")
...
async def toba21(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/27")
...
async def toba22(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/28")
...
async def toba23(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/29")
...
async def toba24(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/30")
...
async def toba25(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/31")
...
async def toba26(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/32")
...
async def toba27(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/33")
...
async def toba28(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/34")
...
async def toba29(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/35")
...
async def toba30(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    await m.message.delete()
    await m.message.reply_audio("https://t.me/UDSTSG/36")
