...
✓ هو الان عليه شخايه يععععععععععع 😹😵"""])
 ...
 هو الان عليه بربور يععععععععععع 😹😪"""])
    ...
    await stickerall(m, ["بص", "بصي", "بص كده"], "https://t.me/UGHFB/4")
    await stickerall(m, ["اجري", "إجري", "أجري"], "https://t.me/UGHFB/7")
    await stickerall(m, ["مكسوفة", "مكسوفه"], "https://t.me/UGHFB/9")
    await stickerall(m, ["عاش"], "https://t.me/UGHFB/10")
    await stickerall(m, ["جامد"], "https://t.me/UGHFB/11")
    await stickerall(m, ["دماغ"], "https://t.me/UGHFB/12")
    await stickerall(m, ["بفكر"], "https://t.me/UGHFB/13")
    await stickerall(m, ["حبكي"], "https://t.me/UGHFB/14")
    await stickerall(m, ["قططتي"], "https://t.me/UGHFB/15")
    await stickerall(m, ["بطه"], "https://t.me/UGHFB/16")
    await stickerall(m, ["قمر"], "https://t.me/UGHFB/17")
    await stickerall(m, ["كتكوت"], "https://t.me/UGHFB/18")
    await stickerall(m, ["حزين"], "https://t.me/UGHFB/19")
    await stickerall(m, ["ماتيجي", "متيجي", "متيقي"], "https://t.me/UGHFB/21")
    await stickerall(m, ["اسطوره"], "https://t.me/UGHFB/22")
    await stickerall(m, ["عشه"], "https://t.me/UGHFB/23")
    await stickerall(m, ["فقير"], "https://t.me/UGHFB/24")
    await stickerall(m, ["بصلي"], "https://t.me/UGHFB/25")
    await stickerall(m, ["احزنني"], "https://t.me/UGHFB/26")
    await stickerall(m, ["جمدان"], "https://t.me/UGHFB/27")
    await stickerall(m, ["حرامي"], "https://t.me/UGHFB/28")
    await stickerall(m, ["اتفق", "اتفق"], "https://t.me/UGHFB/29")
    await stickerall(m, ["عادل شكل", "قلقاسه", "الناحو", "الزعامه"], "https://t.me/UGHFB/30")
    await stickerall(m, ["م عارف", "مش عارف"], "https://t.me/UGHFB/31")
    await stickerall(m, ["error", "ايرور", "404"], "https://t.me/UGHFB/32")
    await stickerall(m, ["صدمتني", "صدمه"], "https://t.me/UGHFB/33")

    # rep one sticker ====================
    # await sticker1(m, "t", "sticker link")
    await sticker1(m, "يتي", "https://t.me/UGHFB/34")

    # rep audio one
    await audioall(m, ["كتاب حياتي ياعين", "كتاب حياتي"], "https://t.me/UGHFB/35")
