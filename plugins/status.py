...
async def love(c: Client, m: CallbackQuery):
    ...
    if m.message.reply_to_message:
        await m.message.reply_to_message.reply_video("https://t.me/UUDSAFH/" + random.choice(statusvideo),
                                caption=f"By: @{get_bot_information()[1]}"),
    else:
        await m.message.reply_video("https://t.me/UUDSAFH/" + random.choice(statusvideo),
                                caption=f"By: @{get_bot_information()[1]}"),
